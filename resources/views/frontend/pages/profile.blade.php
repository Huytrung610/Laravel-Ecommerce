    ...
    <div class="member-container tw-bg-gray-100">
        <section class="container tw-min-h-screen tw-pt-5">
            ...
            <div class="tw-grid tw-grid-cols-[1fr_2.4fr] tw-gap-8 tw-py-8 tw-px-4 tw-bg-white">
                <div class="user-name tw-shadow-xl">
                    ...
                    <ul class="nav flex-column nav-pills me-3" id="v-pills-profile-tab" role="tablist" aria-orientation="vertical">
                        <li class="item-user tw-p-2 tw-font-bold active" id="v-pills-profile-tab" 
                            data-bs-toggle="pill" data-bs-target="#v-pills-profile" 
                            role="tab" aria-controls="v-pills-profile" 
                            aria-selected="true">
                            Profile information
                        </li>
                        <li class="item-user tw-p-2 tw-font-bold tw-text-black" id="v-pills-order-manage-tab" 
                            data-bs-toggle="pill" data-bs-target="#v-pills-order-manage" 
                            role="tab" aria-controls="v-pills-order-manage" 
                            aria-selected="false">
                            Order management
                        </li>
                        <li class="item-user tw-p-2 tw-font-bold tw-text-black" id="v-pills-change-pw-tab" 
                            data-bs-toggle="pill" data-bs-target="#v-pills-change-pw" 
                            role="tab" aria-controls="v-pills-change-pw" 
                            aria-selected="false">
                            Change password
                        </li>
                        <li class="item-user tw-p-2 tw-font-bold tw-text-black" id="v-pills-address-list-tab" 
                            data-bs-toggle="pill" data-bs-target="#v-pills-address-list" 
                            role="tab" aria-controls="v-pills-address-list" 
                            aria-selected="false">
                            Address list
                        </li>
                        <li class="item-user tw-p-2 tw-font-bold tw-text-black" id="v-pills-settings-tab" 
                ...
                <div class="tab-content tw-px-4" id="v-pills-tabContent">
